...
@Component({
  ...
  template: `
    <div *ngIf="type === 'image'" style="padding-left: 15px;">
    ...
    <div *ngIf="type === 'actions'" style="padding-left: 15px; width: 90px;">
    ...
    <div *ngIf="type === 'actionView'" style="padding-left: 15px; width: 50px;">
      <button type="button" style="margin-left: 5px; display: inline-block;"
    ...
    <div *ngIf="type === 'actionsField'" style="padding-left: 15px; width: 130px;">
      <button type="button" style="margin-left: 5px; display: inline-block; background: #3b8dd2;"
              class="btn btn-primary btn-sm"
              (click)="clickButtonRow($event,'edit')">
        <i class="fa fa-pencil" aria-hidden="true"></i>
    ...
    <div *ngIf="type === 'actionsWithPlus'" style="padding-left: 15px; width: 120px;">
      <button type="button" style="margin-left: 5px; display: inline-block;"
              class="btn btn-primary btn-sm"
              (click)="clickButtonRow($event,'edit')">
        <i class="fa fa-pencil" aria-hidden="true"></i>
      ...
      <button type="button" style="margin-left: 5px; display: inline-block;"
              class="btn btn-success btn-sm"
              (click)="clickButtonRow($event,'plus')">
        <i class="fa fa-plus" aria-hidden="true"></i>
      </button>
    </div>

    <div *ngIf="type === 'actionsMinusView'" style="padding-left: 15px; width: 90px;">
      <button type="button" style="margin-left: 5px; display: inline-block; background: #3b8dd2;"
              class="btn btn-primary btn-sm"
              (click)="clickButtonRow($event,'edit')">
        <i class="fa fa-pencil" aria-hidden="true"></i>
    ...
    <div *ngIf="type === 'select'" style="padding-left: 15px;">
      <select class="form-control">
        <option *ngFor="let val of value">
          {{val}}
        </option>
      </select>
    </div>
